...
class editorgui:
    ...
    def __initcontrol(self):
        ...
        folderbutton = tk.Button(lframe, text = 'open folder', command = lambda:self.threadfunc(self.__openfolder))
        folderbutton.pack()
    ...
    def __findwindow(self):
        ...
        targettext.pack()
        #查找按钮
        findbutton = tk.Button(findwin, text = 'find', command = lambda:self.text.findtext(targettext.get()))
        findbutton.pack()
